(function () {
  ...
  const PRODUCTS = {
    ...
    towel: {
      ...
      image: `${IMG}/便携/一次性浴巾.png`,
      packageId: "包号 131318",
      batchId: "批号 65489252088",
      chainHash: "0x8c52…6e4b91",
      chainTime: "2026-01-06 11:22:15",
      production: {
        origin: "新疆乌苏",
        factory: "乌苏利华棉业有限公司",
        date: "2025.11.25",
      ...
      timeline: [
        {
          ...
          chainTime: "2025.10.14 10:02:18",
          image: `${IMG}/便携/一次性洗脸巾.png`,
          facts: ["乌苏优质长绒棉区 · 加宽加厚浴巾专用原料", "亩均节水 40%"],
        },
        {
          title: "轧花加工",
          time: "2025.11.25",
          chainTime: "2025.11.25 15:08:33",
          image: `${IMG}/便携/一次性浴巾.png`,
          facts: ["乌苏利华 · L 级 · 毛重 145.0 KG"],
        },
        {
          title: "纺纱织造",
          time: "2025.12.10",
          chainTime: "2025.12.10 10:40:18",
          image: `${IMG}/便携/一次性浴巾.png`,
          facts: [
            "库尔勒一次性用品合作集群",
            "纯棉水刺无纺布 · 加厚加大规格",
        ...
        },
        {
          ...
          chainTime: "2026.01.06 11:22:15",
          image: `${IMG}/便携/一次性浴巾.png`,
          facts: ["检测机构：自治区产品质量监督检验研究院", "合格编号：XJ-WJ-2026-0106-3418"],
        },
      ],
      diary: {
        title: "棉农日记 · 旅途里的厚实安心",
        text: "加厚浴巾要够大、够软。我们按订单标准采棉，送到车间时包号、批号都清清楚楚。旅客扫码就能看见，这包浴巾从哪块地、哪个厂来。",
      },
      brandStory: "加宽加厚的一次性浴巾，依然来自可溯源的新疆好棉。洁净出行，品质有据可查。",
    },
    coaster: {
      name: "艾德莱斯杯垫",
